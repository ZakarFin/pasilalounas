...
const rafla = require('./amica-insinoorit-ja-ekonomit');
...
describe(rafla.name, () => {
  describe('"parse"', () => {
    it('should return a menu', () => {
        ...
        var contents = fs.readFileSync(__dirname + '/amica-insinoorit.json').toString();
        var result = rafla.parse(JSON.parse(contents));
        console.log(result);
      });
  });
  /*
