...
var places = [
    ...
    require('./adapters/signorsmith'),
    require('./adapters/keltasirkku'),
    require('./adapters/tower'),
...
//    require('./adapters/blancco'),
    ...
    require('./adapters/fazer-paaraide'),
    require('./adapters/ninan-keittio'),
    require('./adapters/iso-paja'),
    require('./adapters/dylan-bole'),
    require('./adapters/limepark')
];
